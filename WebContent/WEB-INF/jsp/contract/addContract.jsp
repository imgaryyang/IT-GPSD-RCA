						...
						<div id="contractDetailContainer" class="ibm-container">								
							<div id="ibm-leadspace-head" class="ibm-alternate">
								<div id="ibm-leadspace-body">
									<ul id="ibm-navigation-trail">
										...
										<li><a href="/ISCRCA/showAddContract.htm">Add Account</a></li>
									</ul>									
									<h1 class="ibm-small">Add Account</h1>
									<!--<p><em></em></p>-->
																		
								</div>	
							</div>
							<h2 class="ibm-rule" style="display:none">Add Account</h2>
							...
							<div id="body" class="ibm-container-body">
								...
								<div id="contractInformation">
									...
									<div id="addContractResponseDiv"><p><span id="addContractResponse" style="color: #ff0000;"></span>
										<br/></p>
									</div>
								...
								<!--	<p id="radioButtons">
                                           <div role="radiogroup" aria-label="Customer">										
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												...
												<form:radiobutton id="unListed" path="contractHelper.customerPreference" value="Unlisted" onclick="return myOnClick();"/>
										...
										<div class="ibm-rule"><hr//></div>
											<div class="ibm-columns">
												<div class="ibm-col-6-1">
													<p><input value="Submit" name="ibm-submit" class="ibm-btn-pri" type="button" onClick="addContract();"></p>
												</div>
											</div>
									</form:form>
									<!-- FORM_END -->
