				...
				<div class="ibm-columns">
					...
					<div id="progress-bar" style="color: gray; display:none" align="center">
						...
						<div id="ibm-leadspace-head" class="ibm-alternate">
							...
							<form:form id="generateMonthlyForm" action="generateMonthlyForm.htm"  commandName="monthlyForm" cssClass="ibm-column-form ibm-styled-form" enctype="multipart/form-data" method="post">
