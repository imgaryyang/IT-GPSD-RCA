...
/**
 * This class and CSVWriter were both on a newsgroup java.programming or
 * something to that nature. I found them through google. there was no license
 * attached to them other than the authors names. So I will put them here: Roedy
 * Green roedy@mindprod.com, Heinrich Goetzger goetzger@gmx.net
 *
 */
public class CSVReader {
     ...
     *          true if reader should allow quoted fields to span more than one
     *          line. Microsoft Excel sometimes generates files like this.
     * @param trim
     *          true if reader should trim lead/trailing whitespace e.g. blanks,
     *          Cr, Lf. Tab off fields.
     */
            ...
            default:
                if (c == quote) {
                    return QUOTE;
                                 ...
                                 * dynamically determined so can't use as case
                                 * label
                                 */) {
                    return SEPARATOR;
                }
    ...
    /**
     * false means next EOL marks an empty field true means next EOL marks the end
     * of all fields.
     */
     ...
     *
     * @return String value, even if the field is numeric. Surrounded and embedded
     *         double quotes are stripped. possibly "". null means end of line.
     * @exception EOFException
                        ...
                        switch (category) {
                            ...
                            case EOL:
                                if (allowMultiLineFields) {
                                    ...
                                    // we are done with that line, but not with the
                                    // field.
                                    // We don't want to return a null
                                    // to mark the end of the line.
                                    line = null;
                                    // will read next line and seek the end of the
                                    // quoted field.
    ...
    /**
     * Make sure a line is available for parsing. Does nothing if there already is
     * one.
     *
     * @exception EOFException
     */
     ...
     *
     * @param fields
     *          How many field you want to bypass reading. The newline counts as
     *          one field.
     * @exception EOFException
     *              at end of file after all the fields have been read.
     * @exception IOException
